...
import HowEnFaunaWorks from "../Components/Home/How";
  ...
  return (
    ...
    >
      ...
      <div className="relative h-screen w-full overflow-hidden bg-black">
        {/* Social Media Links with Vertical Line - Hide on mobile */}
        <div className="absolute left-3 md:left-6 top-1/4 z-20 hidden md:flex flex-col items-center">
        ...
        {/* Social Media Links for Mobile - Show on mobile at bottom with fixed position */}
        <div className="fixed bottom-6 left-0 right-0 z-40 flex md:hidden justify-center">
          <div className="flex gap-8 bg-black/50 px-6 py-3 rounded-full backdrop-blur-sm">
            <a
              href="#"
              className="text-white hover:text-green-400 transition-colors duration-300"
            >
        ...
        <div className="relative h-full">
              ...
              <div className="relative h-full flex items-center z-10">
                <div className="container mx-auto px-4 md:px-12 lg:px-24">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-white/80 text-base md:text-lg mb-6 md:mb-8 max-w-xl">
                      {slide.subtitle}
                    </p>
                    ...
                    <Link
                      to="/explore"
                      className="bg-white text-black px-6 sm:px-8 py-2 sm:py-3 rounded-sm flex items-center gap-2 group hover:bg-green-500 hover:text-white transition-all duration-300 w-32 sm:w-36"
                    >
                      Explore
                    ...
                    <div className="mt-8 md:mt-12">
                      <span className="inline-flex items-center gap-2 text-white/80 text-sm md:text-base">
                        <svg
                          className="w-4 h-4"
                          fill="none"
                          stroke="currentColor"
          ...
          {/* Thumbnail Navigation - Hide on small mobile */}
          <div className="absolute bottom-8 right-2 sm:right-4 md:right-8 z-20">
            <div className="flex gap-2 md:gap-4">
              {slides.map((slide, index) => (
                <button
                  key={index}
                  onClick={() => setCurrentSlide(index)}
                  className={`relative w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-lg overflow-hidden transition-all duration-300 ${
                    currentSlide === index
                      ? "ring-2 ring-white"
      ...
      {/* Stats and Spotlight Sections - Responsive padding */}
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12 bg-slate-50 dark:bg-gray-950">
        <StatsSection />

        {/* Species Spotlight */}
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-4 sm:p-6 md:p-10 mb-8 md:mb-12 py-8 md:py-12">
          <SpotlightSection />
        </div>
      </div>
    </div>
