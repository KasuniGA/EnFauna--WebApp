...
const CustomAlert = ({ variant = 'default', children }) => {
  const styles = {
    default: 'bg-green-50 dark:bg-gray-800 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-700',
  ...
  return (
    <div className={`flex items-center gap-2 p-4 rounded-lg border ${styles[variant]} animate-fadeIn`}>
      {children}
    </div>
  );
};
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-20 my-20 max-w-2xl mx-auto p-8 bg-white bg-opacity-90 dark:bg-slate-800 dark:bg-opacity-90 rounded-xl shadow-xl transition-all duration-300 hover:shadow-2xl">
        <div className="flex items-center gap-3 mb-8 transform transition-transform hover:translate-x-2">
          ...
          <h2 className="text-2xl font-bold text-emerald-700 dark:text-emerald-200">Upload Wildlife Photo</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative transition-all duration-300 transform hover:scale-[1.01]">
            {!preview ? (
              <div className="border-3 border-dashed border-emerald-300 dark:border-emerald-600 rounded-lg p-10 text-center hover:border-emerald-500 dark:hover:border-emerald-400 transition-colors bg-white bg-opacity-50 dark:bg-slate-700 dark:bg-opacity-40">
                ...
                <p className="text-emerald-700 dark:text-emerald-200 font-medium">Drag and drop your photo here or click to browse</p>
                <p className="text-sm text-emerald-600 dark:text-emerald-300 mt-2 opacity-80">Maximum file size: 10MB (JPG, PNG)</p>
              </div>
            ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2 transform transition-all duration-300 hover:translate-y-[-2px]">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border rounded-lg bg-emerald-50 dark:bg-slate-600 text-emerald-800 dark:text-emerald-50 border-emerald-200 dark:border-emerald-600 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200"
                >
                ...
                {formData.species === 'Other' && (
                  <input
                    ...
                    className="w-full px-4 py-3 border rounded-lg bg-emerald-50 dark:bg-slate-600 text-emerald-800 dark:text-emerald-50 border-emerald-200 dark:border-emerald-600 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 placeholder-emerald-400 dark:placeholder-emerald-300 transition-all duration-200 animate-fadeIn"
                  />
                )}
              </div>
          ...
          {success && (
            <CustomAlert variant="success">
              ...
              <span className="animate-fadeIn">Photo uploaded successfully!</span>
            </CustomAlert>
          )}
